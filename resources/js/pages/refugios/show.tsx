        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {/* Header Profile */}
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 mb-8 text-center md:text-left md:flex md:items-start md:gap-8 border border-slate-200">
                        <div className="h-32 w-32 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 font-bold text-4xl mx-auto md:mx-0">
